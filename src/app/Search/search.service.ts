...
//     this.httpClient.get('https://api.github.com/users/' + this.username +"/repos?access_token=" + this.token ).toPromise().then(
//       reporesults=>{
//         this.findrepositories=reporesults
//         this.repo.name=["name"]
//         console.log(this.findrepositories)
//         // this.myrepo.name=reporesults["name"]
//         // this.myrepo.html_url=reporesults["html_url"]
//         // this.myrepo.created_at=reporesults["created_at"]
//         // this.myrepo.description=reporesults["description"]
//         resolve();
//       },
//       error=>{
//         // this.myrepo.name="Not Found"
//         // this.myrepo.html_url="#"
//         // this.myrepo.created_at=new Date()
//         // this.myrepo.description="Not Found"
//         reject(error);
//       }
//     )
//
